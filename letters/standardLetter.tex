...
mit großem Interesse habe ich die ausgeschriebene Stelle als \stelleText~\firmaText~zur Kenntnis genommen. Besonders reizt mich die Aussicht, meine breit gefächerte wissenschaftliche Expertise in der Proteinforschung und Analyse \phrase~in einem dynamischen und innovativen Umfeld einzubringen. In Verbindung mit meinen Erfahrungen im akademischen Projektmanagement und der Kooperation mit international tätigen Projektpartnern und Lieferanten bin ich überzeugt, dass ich einen wertvollen Beitrag zur Weiterentwicklung Ihres Unternehmens leisten kann. \par
...
\ifthenelse{\equal{\typ} {Lehre}}
    ...
    mit Cloning und Genexpression, sowie in Proteinreinigungs- und Analysmethoden und der hochauflösenden Röntgenkristallografie. In meiner aktuellen Stelle befasse ich mich inhaltlich primär mit Proteinlabeling von \textit{Aerolysin} zur Verbesserung der Proteinsequenzierung durch Nanoporanalyse. Dabei kommen neben den bereits beschriebenen \textit{in-vivo}-Methoden zur Proteinproduktion neue \textit{in-vitro}-Techniken wie \textit{custom unnatural amino acids} und \textit{tRNA} zum Einsatz.} Mein Interesse reicht allerdings weit über den reinen Fachbereich hinaus, weshalb ich mich kontinuierlich weiterbilde. So habe ich mich neben verschiedenen fachspezifischen Fortbildungen \ifthenelse{\equal{\typ} {Lehre}}{}{ zu \textit{GMP} und \textit{Sicherheit in der Gentechnik} }bereits mit BWL und Projektmanagement beschäftigt. Ich habe außerdem eine hohe IT-Affinität und kenne mich mit unterschiedlichen Software-Tools bestens aus. Es ist unausweichlich, sich im akademischen Betrieb neben fundiertem Fachwissen auch solide Kenntnisse in der Informations- und Datenverarbeitung zu erarbeiten.
